...
except kick. Kick will deliver zero to minimal damage if the opponent isn't blocking, but it will deliver a decent amount of damage if the opponent is blocking. Kick also has
long startup and recovery time, as its main use is to break an opponents shield.